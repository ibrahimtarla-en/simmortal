...
async function EditMemorialLivePortraitPage({ params }: DynamicRouteParams<{ id: string }>) {
  ...
  return <CreateEditMemorial.LivePortrait initialValues={initialValues} />;
}

export default EditMemorialLivePortraitPage;
