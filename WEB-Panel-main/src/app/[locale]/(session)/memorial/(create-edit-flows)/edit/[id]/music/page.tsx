...
async function EditMemorialMusicPage({ params }: DynamicRouteParams<{ id: string }>) {
  ...
  return <CreateEditMemorial.Music initialValues={initialValues} />;
}

export default EditMemorialMusicPage;
